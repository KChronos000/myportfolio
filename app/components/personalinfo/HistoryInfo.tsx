    ...
    <section className='py-4 flex justify-center items-center'>
      <div className="container">
        <div className="flex flex-col justify-center items-center p-2 lg:p-0 gap-4">
          ...
          <div className="dark:bg-zinc-800/70 dark:text-gray-300 rounded-md border-2 dark:border-none shadow-md hover:transition-all hover:duration-500 hover:scale-105">
